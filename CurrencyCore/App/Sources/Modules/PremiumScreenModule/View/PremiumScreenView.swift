...
private extension PremiumScreenView {
  ...
  func applyDefaultBehavior() {
    ...
    tableView.backgroundColor = SKStyleAsset.onyx.color
    
    dividerView.backgroundColor = SKStyleAsset.constantSlate.color
    
    restorePurchaseButton.setTitle(appearance.restoreTitle, for: .normal)
    restorePurchaseButton.setTitleColor(SKStyleAsset.constantAzure.color, for: .normal)
    ...
    bottomContainerView.backgroundColor = SKStyleAsset.onyx.color
    ...
    loaderLabel.font = .fancy.text.regular
    loaderLabel.textColor = SKStyleAsset.ghost.color
...
private extension PremiumScreenView {
  struct Appearance {
    ...
    let termsConditions = CurrencyCoreStrings.PremiumScreenLocalization.terms
    let andTitle = CurrencyCoreStrings.PremiumScreenLocalization.and
    let privacyPolicy = CurrencyCoreStrings.PremiumScreenLocalization.privacyPolicy
    let restoreTitle = CurrencyCoreStrings.PremiumScreenLocalization.restore
    ...
    let monthlyTitle = CurrencyCoreStrings.PremiumScreenLocalization.monthly
    let mostPopularTitle = CurrencyCoreStrings.PremiumScreenLocalization.mostPopular
    let monthlyCountTitle = "1"
    
    let yearlyTitle = CurrencyCoreStrings.PremiumScreenLocalization.annually
    let sevenDaysFreeTitle = CurrencyCoreStrings.PremiumScreenLocalization.sevenDaysFree
    let yearlyCountTitle = "12"
    
    let lifetimeTitle = CurrencyCoreStrings.PremiumScreenLocalization.forever
    let oneTimePurchaseTitle = CurrencyCoreStrings.PremiumScreenLocalization.oneTimePurchase
    let oneTimePCountTitle = "∞"
    
    let cardPaymentLoader = CurrencyCoreAsset.paymentInProcess.name
    let processingPaymentTitle = CurrencyCoreStrings.PremiumScreenLocalization.processingPayment
