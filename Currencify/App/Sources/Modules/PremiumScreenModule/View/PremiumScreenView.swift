...
private extension PremiumScreenView {
  struct Appearance {
    ...
    let termsConditions = CurrencifyStrings.PremiumScreenLocalization.terms
    let andTitle = CurrencifyStrings.PremiumScreenLocalization.and
    let privacyPolicy = CurrencifyStrings.PremiumScreenLocalization.privacyPolicy
    let restoreTitle = CurrencifyStrings.PremiumScreenLocalization.restore
    ...
    let monthlyTitle = CurrencifyStrings.PremiumScreenLocalization.monthly
    let mostPopularTitle = CurrencifyStrings.PremiumScreenLocalization.mostPopular
    let monthlyCountTitle = "1"
    
    let yearlyTitle = CurrencifyStrings.PremiumScreenLocalization.annually
    let sevenDaysFreeTitle = CurrencifyStrings.PremiumScreenLocalization.sevenDaysFree
    let yearlyCountTitle = "12"
    
    let lifetimeTitle = CurrencifyStrings.PremiumScreenLocalization.forever
    let oneTimePurchaseTitle = CurrencifyStrings.PremiumScreenLocalization.oneTimePurchase
    let oneTimePCountTitle = "∞"
    
    let cardPaymentLoader = CurrencifyAsset.paymentInProcess.name
    let processingPaymentTitle = CurrencifyStrings.PremiumScreenLocalization.processingPayment
